...
function createLight() {
    ...
    var ambientLt = new THREE.AmbientLight(0xffffff, 1.0);
    scene.add(ambientLt);
}
...
function createModel() {
    ...
    jsonLoader.load('./mouse.json', addScan);
}

function addScan(geometry, material){
...
function createOrbit() {
    ...
    control.object.position.set(-50,20, 50);
